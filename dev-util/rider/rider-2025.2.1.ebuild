...
DESCRIPTION="Leading cross-platform IDE for .NET and game developers"
HOMEPAGE="https://www.jetbrains.com/rider/"
SRC_URI="https://download-cdn.jetbrains.com/rider/JetBrains.Rider-${PV}.tar.gz   -> ${P}.tar.gz"
...
src_install() {
	...
	insinto "${dir}"
	doins -r *
	fperms 755 "${dir}"/bin/{rider.sh,fsnotifier,inspect.sh,ltedit.sh,restarter}
